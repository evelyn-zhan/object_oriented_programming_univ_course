...
class DaftarDosen:
    ...
    def tambah(self, dosen):
        self.isi.append(dosen)
...
def absensi():
    ...
    jumlah_mahasiswa = daftar_mahasiswa.jumlah()
    if jumlah_mahasiswa == 0:
        print('Belum ada data mahasiswa.')
    else:
        print(f'Terdapat {jumlah_mahasiswa} orang mahasiswa.')
        for mahasiswa in daftar_mahasiswa.isi:
            print(mahasiswa)
    
    print('-' * 80)

    print('Daftar dosen:')
    jumlah_dosen = daftar_dosen.jumlah()
    if jumlah_dosen == 0:
        print('Belum ada data dosen.')
    else:
        print(f'Terdapat {jumlah_dosen} orang dosen.')
        for dosen in daftar_dosen.isi:
            print(dosen)
